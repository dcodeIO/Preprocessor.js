...
"/"+e)+"",this.source=this.source.substring(0,b.index)+a.indent(e,f)+this.source.substring(a.e.lastIndex)}catch(k){throw Error("File not found: "+e+" ("+k+")");}a.a.lastIndex=0<g.length?g[g.length-1].lastIndex:0;c("  continue at "+a.a.lastIndex);break;case "put":a.f.lastIndex=b.index;if((d=a.f.exec(this.source))===j)throw Error("Illegal #"+b[2]+": "+this.source.substring(b.index,b.index+this.c)+"...");e=d[1];console.log("  expr: "+d[1]);e=a.evaluate(h,d[1]);c("  value: "+a.nlToStr(e));this.source=
this.source.substring(0,b.index)+f+e+this.source.substring(a.f.lastIndex);a.a.lastIndex=b.index+e.length;c("  continue at "+a.a.lastIndex);break;case "ifdef":case "ifndef":case "if":a.d.lastIndex=b.index;if((d=a.d.exec(this.source))===j)throw Error("Illegal #"+b[2]+": "+this.source.substring(b.index,b.index+this.c)+"...");c("  test: "+d[2]);e="ifdef"==d[1]?!!h[d[2]]:"ifndef"==d[1]?!h[d[2]]:a.evaluate(h,d[2]);c("  value: "+e);g.push(b={include:e,index:b.index,lastIndex:a.d.lastIndex});c("  push: "+
JSON.stringify(b));break;case "endif":case "else":case "elif":a.b.lastIndex=b.index;if((d=a.b.exec(this.source))===j)throw Error("Illegal #"+b[2]+": "+this.source.substring(b.index,b.index+this.c)+"...");if(0==g.length)throw Error("Unexpected #"+d[1]+": "+this.source.substring(b.index,b.index+this.c)+"...");f=g.pop();c("  pop: "+JSON.stringify(f));e=this.source.substring(f.lastIndex,b.index);f.include?(c("  incl: "+a.nlToStr(e)+", 0-"+f.index+" + "+e.length+" bytes + "+a.b.lastIndex+"-"+this.source.length),
this.source=this.source.substring(0,f.index)+e+this.source.substring(a.b.lastIndex)):(c("  excl: "+a.nlToStr(e)+", 0-"+f.index+" + "+a.b.lastIndex+"-"+this.source.length),e="",this.source=this.source.substring(0,f.index)+this.source.substring(a.b.lastIndex));""==this.source&&c("  result empty");a.a.lastIndex=f.index+e.length;c("  continue at "+a.a.lastIndex);if("else"==d[1]||"elif"==d[1])e="else"==d[1]?!f.include:a.evaluate(h,d[2]),g.push(b={include:!f.include,index:a.a.lastIndex,lastIndex:a.a.lastIndex}),
c("  push: "+JSON.stringify(b))}}0<g.length&&(f=g.pop(),c("Still on stack: "+JSON.stringify(f)));return this.source};a.prototype.toString=function(){return"Preprocessor"};"undefined"!=typeof module&&module.exports?module.exports=a:"undefined"!=typeof define&&define.amd?define("Preprocessor",[],function(){return a}):(k.dcodeIO||(k.dcodeIO={}),k.dcodeIO.Preprocessor=a)})(this);
